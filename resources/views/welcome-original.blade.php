            ...
            <div class="mt-8 sm:mt-16">
                <div class="hidden sm:block">
                    <img class="object-contain w-auto mx-auto rounded-lg dark:hidden h-[600px]"
                         src="{{ asset('images/hero/phone-mockup.png') }}" alt="">
                    <img class="hidden object-contain w-auto mx-auto rounded-lg dark:block h-[600px]"
                         src="{{ asset('images/hero/phone-mockup-dark.png') }}" alt="">
                </div>
        ...
        <div class="max-w-screen-xl px-4 py-8 mx-auto sm:py-16 lg:py-24">
            <div class="grid grid-cols-1 gap-8 lg:gap-16 lg:grid-cols-2">
                ...
                <div class="hidden lg:block">
                    <img class="object-cover w-full dark:hidden" src="{{ asset('images/cta/phone-mockup.png') }}"
                         alt="Phone mockup">
                    <img class="hidden object-cover w-full dark:block" src="{{ asset('images/cta/phone-mockup-dark.png') }}"
                         alt="Phone mockup">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-8 mt-8 lg:mt-20 lg:gap-16 lg:grid-cols-2">
                <div class="hidden lg:block">
                    <img class="object-cover w-full dark:hidden" src="{{ asset('images/cta/feature-illustration.png') }}"
                         alt="Feature illustration">
                    <img class="hidden object-cover w-full dark:block"
                         src="{{ asset('images/cta/feature-illustration-dark.png') }}" alt="Feature illustration">
                </div>
        ...
        <div class="max-w-screen-xl px-4 py-8 mx-auto sm:py-16 lg:py-24">
            <div class="items-center gap-8 xl:gap-16 md:grid md:grid-cols-2">
                ...
                <div class="hidden md:flex">
                    <img class="mx-auto w-96 dark:hidden" src="{{ asset('images/mobile-app-mockup.png') }}" alt="mobile app">
                    <img class="hidden mx-auto w-96 dark:block" src="{{ asset('images/mobile-app-mockup-dark.png') }}"
                         alt="mobile app">
                </div>
            </div>
        </div>
